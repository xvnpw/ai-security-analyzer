...
AGENT_PROMPT_TYPES="sec-design attack-tree"
...
temperatures["deepseek/deepseek-r1"]="0.2"
...
for agent_prompt_type in $AGENT_PROMPT_TYPES; do
    ...
    for agent_model in "${!models[@]}"; do
        ...
        printf "| [screenshot-to-code](https://github.com/abi/screenshot-to-code)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](dir-${agent_prompt_type}-screenshot-to-code-${safe_agent_model}.md) |\n" "$CMD" >> examples/README.md
    done
done
...
#         printf "| [AI Nutrition-Pro](../tests/EXAMPLE_ARCHITECTURE.md)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](file-${agent_prompt_type}-ai-nutrition-pro-${safe_agent_model}.md) |\n" "$CMD" >> examples/README.md
#     done
# done
...
#         printf "| [flask](https://github.com/pallets/flask)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](github-${agent_prompt_type}-flask-${safe_agent_model}.md) |\n" "$CMD" >> examples/README.md
#     done
# done
...
#         printf "| [flask](https://github.com/pallets/flask)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](github-da-${agent_prompt_type}-flask-${safe_agent_model}.md), [deep-analysis](github-da-${agent_prompt_type}-flask-${safe_agent_model}-deep-analysis.md) |\n" "$CMD" >> examples/README.md
#     else
#         printf "| [flask](https://github.com/pallets/flask)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](github-da-${agent_prompt_type}-flask-${safe_agent_model}.md) |\n" "$CMD" >> examples/README.md
#     fi
...
#         printf "| [terraform-provider-chronicle](https://github.com/form3tech-oss/terraform-provider-chronicle)<br/><details><summary>commands...</summary>\`\`\`bash %s\`\`\`</details> | python | $agent_model | [${agent_prompt_type}](dir-${agent_prompt_type}-terraform-provider-chronicle-${safe_agent_model}.md) |\n" "$CMD" >> examples/form3tech-oss/README.md
#     done
# done
